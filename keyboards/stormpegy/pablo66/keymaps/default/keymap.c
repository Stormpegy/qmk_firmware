...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT( \
    ...
    KC_TAB,  KC_Q, KC_W, KC_E, KC_R, KC_T, KC_DOT,                    KC_DOT, KC_Y, KC_U, KC_I, KC_O, KC_P, R16, \
    KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_DOT,                    KC_DOT, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, \
    KS_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_ENTER,                  KC_ENTER, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_DOT, \
